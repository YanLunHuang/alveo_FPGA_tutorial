...
void myproject(
    ...
    hls::stream<result_t> layer2_out[8]
) {
    ...
    nnet::zeropad2d_cl_switch<input_t, layer4_t, config4>(input_1, layer4_out); // zp2d_conv2d

    nnet::conv_2d_cl_switch<layer4_t, result_t, config2>(layer4_out, layer2_out, w2, b2); // conv2d
